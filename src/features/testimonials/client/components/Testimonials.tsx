...
const Testimonials =  () => {
  const { loading, totalSlides, currentSlide, direction, imageLoadedStates, setCurrentSlide, handleImageLoad, setDirection, displayTestimonials } =  useTestimonials()
  if (loading) {
    return (
          ...
          >
            ...
            >
              <motion.button
                ...
                className="group w-12 h-12 rounded-full border cursor-pointer border-white/10 hover:border-primary/50 flex items-center justify-center transition-all duration-300 backdrop-blur-sm bg-white/2"
          ...
          <div className="relative min-h-[400px] lg:min-h-[500px] overflow-hidden">
            ...
            <div className="relative h-full">
              <AnimatePresence mode="sync" custom={direction}>
                {displayTestimonials.map((testimonial: ITestimonial, index: number) => {
                          ...
                          <div className="relative">
                            ...
                            <div className="relative gold-border-shine w-14 h-14">
                              <div className="w-full h-full rounded-full overflow-hidden bg-black">
                                {!imageLoadedStates[testimonial.id] && (testimonial.image || "/fallback.jpg") && (
                                ...
                                <Image
                                  ...
                                  onLoadingComplete={() => handleImageLoad(testimonial.id)}
                                />
                              </div>
                            </div>
                          </div>
